...
export default function AffiliateDashboard() {
    const stats = [
        { label: 'Comissão Acumulada', value: 'R$ 1.250,00', icon: ValueIcon, color: 'text-emerald-400', bg: 'bg-emerald-400/10' },
        { label: 'Cliques nos Links', value: '1.458', icon: BarChartIcon, color: 'text-[#FF6B6B]', bg: 'bg-[#FF6B6B]/10' },
        { label: 'Conversões', value: '12', icon: LayersIcon, color: 'text-[#3ABFF8]', bg: 'bg-[#3ABFF8]/10' },
        { label: 'Taxa de Conversão', value: '0.8%', icon: RocketIcon, color: 'text-amber-400', bg: 'bg-amber-400/10' },
    ];
    ...
    const recentClicks = [
        ...
        { product: 'Mecanica365', date: 'Ontem, 18:45', ip: '201.89.XX.XX', status: 'Visita' },
    ];
                    ...
                    <div className="bg-[#121214] border border-white/5 rounded-3xl p-8">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between text-xs">
                                <span className="text-[#6B6B7E]">Progresso (70%)</span>
                                <span className="text-white font-bold">R$ 1.250 / R$ 2.000</span>
                            </div>
                            <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                                <div className="h-full bg-gradient-to-r from-emerald-400 to-[#3ABFF8] w-[70%]" />
                            </div>
                        </div>
                    </div>
                </div>
