...
import { suppliersApi, CreateSupplierDto, DocumentType } from '@/lib/api/suppliers';
  ...
  return (
    <div className="min-h-screen bg-[#0F1115] text-[#D0D6DE] p-6">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-[#D0D6DE] mb-2">Novo Fornecedor</h1>
          <p className="text-[#7E8691]">Cadastre um novo fornecedor no sistema</p>
        </div>
